...
//             </div>
//             <h2
//               className="text-2xl md:text-3xl font-normal mb-4 text-[#DD3333] mt-2"
//               data-aos="fade-up"
//               data-aos-duration="1000"
//               data-aos-delay="200"
//             >
...
//             <p
//               className="mb-4 text-base font-medium md:text-md text-black"
//               data-aos="fade-up"
//               data-aos-duration="1000"
//               data-aos-delay="200"
//             >
...
//                 long distance moving services. <br /> <br />
//                 Lots of planning and preparation is required for successful and
//                 hassle-free home relocation in Dubai. Since the ultimate goal is
...
//                 We pack the goods with the best quality material and take care
//                 that they are not damaged during transit. We load the goods into
//                 the transportation vehicle and thereafter unload the goods at
//                 the destination. At the destination, we are able to verify the
//                 items with the help of a checklist, and thereafter, we move the
//                 goods to the destination place. It does not matter if the goods
//                 are to be moved on the 1st floor or 10th floor. Our team takes
//                 utmost care and compliance so that no damage occurs to your
//                 goods while they are moved to your place.
//               </p>
//             </div>
...
const HouseShifting = () => {
  ...
  return (
    <>
      {isSubmitted ? (
        // Display a confirmation message if the form is submitted
        <div className="max-w-screen-xl mx-auto px-3">
          <div className="bg-[#0772BD] py-3 mt-3">
            <p className="text-white font-medium text-2xl ml-5">
              House Shifting
