      ...
      <div className="flex flex-col md:flex-row my-3 mt-[-30px]">
        ...
        <div className="w-full md:w-2/3">
          ...
          <p className="mb-4 text-base font-medium md:text-md text-black">
            ...
            during our 20 years as a moving company. When we save money, we pass
            that along to our customers in the form of lower overall moving
            costs.
            <br />
            <br /> WE HANDLE EVERYTHING FOR YOUR MOVE <br /> Movers and Packers
            is made up of highly prompt individual who are eager about making a
