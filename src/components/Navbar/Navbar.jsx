        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex ml-10 space-x-6 text-md font-medium">
            ...
            <a
              href="/houseShifting"
              className={`duration-200 hover:text-blue-500 ${
                activeLink === "/houseShifting" ? "text-blue-500" : ""
              }`}
            ...
            <a
              href="/getAQuote"
              className={`duration-200 hover:text-blue-500 ${
                activeLink === "/getAQuote" ? "text-blue-500" : ""
              }`}
      ...
      >
        <div className="flex flex-col space-y-5 text-lg font-medium">
          ...
          <a
            href="/services"
            className={`duration-200 hover:text-cyan-300 ${
              activeLink === "/services" ? "text-cyan-300" : ""
            }`}
            onClick={() => handleLinkClick("/services")}
          >
            Services
          ...
          <a
            href="/houseShifting"
            className={`duration-200 hover:text-cyan-300 ${
              activeLink === "/houseShifting" ? "text-cyan-300" : ""
            }`}
            onClick={() => handleLinkClick("/houseShifting")}
          >
            House Shifting 24/7
          ...
          <a
            href="/getAQuote"
            className={`duration-200 hover:text-cyan-300 ${
              activeLink === "/getAQuote" ? "text-cyan-300" : ""
            }`}
            onClick={() => handleLinkClick("/getAQuote")}
          >
            Get A Quote
          ...
          <a
            href="/contact"
            className={`duration-200 hover:text-cyan-300 ${
              activeLink === "/contact" ? "text-cyan-300" : ""
            }`}
            onClick={() => handleLinkClick("/contact")}
          >
            Contact
